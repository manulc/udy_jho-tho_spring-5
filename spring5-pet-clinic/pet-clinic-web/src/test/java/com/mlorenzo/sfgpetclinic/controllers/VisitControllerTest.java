...
class VisitControllerTest {
    ...
    static final String REDIRECT_OWNERS_1 = "redirect:/owners/{ownerId}";
    static final String YET_ANOTHER_VISIT_DESCRIPTION = "yet another visit";
    ...
    final UriTemplate visitsUriTemplate = new UriTemplate("/owners/{ownerId}/pets/{petId}/visits/new");
