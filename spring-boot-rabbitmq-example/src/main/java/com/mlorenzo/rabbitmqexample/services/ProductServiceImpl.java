...
import com.mlorenzo.rabbitmqexample.config.RabbitMQConfig;
import com.mlorenzo.rabbitmqexample.converters.ProductFormToProduct;
...
public class ProductServiceImpl implements ProductService {
    ...
    public void sendProductMessage(String id) {
        ...
        rabbitTemplate.convertAndSend(RabbitMQConfig.SFG_MESSAGE_QUEUE, actionmap);
    }
}
